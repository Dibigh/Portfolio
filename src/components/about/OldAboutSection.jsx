          ...
          >
            ...
            <motion.div variants={fadeUp} className="glass rounded-2xl p-6 border border-white/8 neon-border-hover">
              <p className="text-[#B5B5B5] leading-relaxed text-sm md:text-base">
                ...
                Sagarmatha Engineering College (2022–2026).
              </p>
              <p className="text-[#B5B5B5] leading-relaxed text-sm md:text-base mt-4">
                I'm deeply interested in <span className="text-[#7B61FF] font-medium">Artificial Intelligence & Machine Learning</span>,
                <span className="text-[#00D9FF] font-medium"> and full-stack web development.</span> My
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap gap-2">
              {['React Ecosystem', 'Deep Learning', 'CNN / ResNet', 'Computer Vision', 'Full Stack',].map((tag) => (
                <span
                  key={tag}
